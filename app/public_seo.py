...
PRODUCTS: dict[str, dict[str, Any]] = {
    "/website-builder": {
        ...
        "related": [("AI website builder", "/ai-website-builder"), ("Zylora Studio", "/zylora-studio"), ("Templates", "/templates")],
    },
    "/ai-website-builder": {
    ...
    "/ai-website-generator": {
        ...
        "faq": [("How long does generation take?", "Generation time depends on the brief and current service conditions; the product is designed to provide a useful starting point quickly."), ("Can I use a catalogue template instead?", "Yes. Zylora also has a public template catalogue for teams that prefer to begin from an art-directed starting point."), ("Does generation change my existing site?", "No. Site creation and editing operate within the existing workspace flows and do not alter other sites without an explicit action." )],
        "related": [("AI website builder", "/ai-website-builder"), ("Website examples", "/website-examples"), ("Templates", "/templates")],
    },
    "/zylora-studio": {
    ...
    "/templates": {
        "title": "Business Website Templates | Zylora",
        "description": "Explore Zylora’s curated business website templates for clinics, agencies, restaurants, portfolios and more.",
        "eyebrow": "Curated starting points",
        "h1": "Start from a direction that already fits the business.",
        "intro": "Zylora templates are designed as real starting points—not anonymous blocks. Explore the catalogue, inspect the preview, and choose a direction that gives your business a head start while keeping the site editable.",
        "visual": "Template preview · Pages · Features · Use this template",
        "workflow": ["Browse by business context or style", "Open a detailed preview", "Choose the starting point that fits", "Customize, connect and publish in your workspace"],
        "capabilities": ["Curated catalogue of verified public templates", "Preview pages before choosing", "Starting points for service, portfolio and local businesses", "A path into the existing editor and publishing workflow"],
        "use_cases": "Useful when the business wants a strong visual starting point and a faster path to a considered site without sacrificing editability.",
        "faq": [("Are templates editable?", "Yes. Templates participate in the existing editing and publishing runtime."), ("Can I see a template before signing up?", "Public previews are available for the catalogue where technically appropriate."), ("Can I start without a template?", "Yes. Zylora’s AI website creation flow can generate a site from a business brief instead." )],
        "related": [("Website examples", "/website-examples"), ("AI website builder", "/ai-website-builder"), ("Templates for restaurants", "/solutions/restaurants")],
    },
    "/custom-domains": {
    ...
    "/pricing": {
        ...
        "related": [("Website builder", "/website-builder"), ("Templates", "/templates"), ("Choose a plan", "/choose-plan")],
    },
}
...
def _footer() -> str:
    groups = [("Product", [("Website Builder", "/website-builder"), ("AI Website Builder", "/ai-website-builder"), ("Zylora Studio", "/zylora-studio"), ("AI Sales Assistant", "/ai-sales-assistant"), ("CRM", "/crm"), ("Appointments", "/appointments")]), ("Solutions", [("Small Business", "/solutions/small-business"), ("Agencies", "/solutions/agencies"), ("Clinics", "/solutions/clinics"), ("Restaurants", "/solutions/restaurants"), ("Freelancers", "/solutions/freelancers"), ("Real Estate", "/solutions/real-estate")]), ("Resources", [("Guides", "/guides/how-to-build-a-business-website"), ("Website Examples", "/website-examples"), ("Templates", "/templates"), ("Blog", "/blog")]), ("Company", [("Pricing", "/pricing"), ("Contact", "/legal"), ("Privacy", "/privacy"), ("Terms", "/terms")])]
    columns = []
...
def website_examples() -> HTMLResponse:
    ...
    return HTMLResponse(_head('Website Examples for Businesses | Zylora', 'Explore useful Zylora website directions for restaurants, clinics, agencies, portfolios, gyms and real estate.', canonical, schema) + '<body>' + body + '</body></html>', headers={'Cache-Control': 'public,max-age=300'})
